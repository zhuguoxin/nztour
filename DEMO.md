...
- [ ] **Demo browser**: Chrome incognito, zoom 110%, tabs:
      1. `https://tourtrain.zhuguoxin.workers.dev` (anonymous, EN)
...
Open <https://tourtrain.zhuguoxin.workers.dev> in the anonymous tab.
...
5. Run reindex: `curl -X POST -H "x-reindex-token: $TOKEN"
   https://tourtrain.zhuguoxin.workers.dev/api/admin/reindex`.
