...
const en = {
  ...
  card_minutes: "~{n} min",
  // Unit-only labels for the stacked stat block on cards (number on its own
  // line, short unit below) — avoids mid-word wrapping in CJK and other scripts.
  card_u_course: "course",
  card_u_courses: "courses",
  card_u_modules: "modules",
  card_u_min: "min",
  ...
  ai_empty_state: "Ask anything about this course.",
  ...
  admin_sup_disabled: "Disabled",
  admin_sup_pending: "Pending",
  admin_sup_enable: "Enable",
  admin_sup_disable: "Disable",
  delisted_course: "This course has been delisted.",
  delisted_product: "This product has been delisted.",
  delisted_supplier: "This supplier has been delisted.",
  delisted_back: "Back to my learning",
  sd_products: "Products ({n})",
  sd_empty: "No products published yet.",
  ...
  ed_regen_heading: "This module · narration preview",
  ed_regen_sub: "Generate this module's narration in the primary language only — a quick listen while editing. All languages are generated at publish.",
  ed_regen_module: "🎧 Generate narration (preview)",
  ed_republish: "Re-generate & publish",
  pub_title: "Publish course",
  pub_sub: "Pick the languages to publish and a voice for each. Translation and narration are generated for every selected language × module in the background, then the course goes live. Save your changes first.",
  pub_no_overwrite: "Don't overwrite existing narration (only fill gaps)",
  pub_running: "Publishing… generating narration",
  pub_toast_running: "Generating narration…",
  pub_toast_done: "Narration ready — course published",
  pub_go: "Publish",
  ed_regenerating: "Regenerating in background…",
  ed_regen_bg: "Running in the background — keep working; you'll get a note when it's done.",
  ...
  ed_minutes: "Estimated length",
  ed_minutes_unit: "min",
  ed_minutes_auto: "Auto-estimated from the course text.",
  ed_status: "Status",
  ed_draft: "draft",
  ...
  em_block_video_yt_ph: "Paste a YouTube share link (youtu.be/… or youtube.com/watch?v=…)",
  em_video_upload: "⬆ Upload video file",
  em_video_uploaded: "Video file uploaded",
  em_video_remove: "Remove file",
  em_video_hint: "MP4 / WebM / MOV ≤ 2 GB. An uploaded file takes priority over the link.",
  ...
  em_block_narrate: "🔊 Include in voiceover",
  em_slide_remove: "Remove slide",
  em_slide_hint: "Select one or more images at once — 2+ show as a slider to learners.",
  em_block_tip:
  ...
  cq_title: "Final exam",
  cq_subtitle: "One exam after all chapters · learners sit it once · passing it earns the badge",
  cq_generate_title: "Generate questions from the whole course",
  cq_empty:
    "No questions yet — without a final exam, the badge is earned by reading every chapter.",
  em_ai_only: "AI-only",
  ...
  ui_video_too_large:
    "This video is {mb} MB, over the 2 GB limit. Please use a smaller file or paste a YouTube link.",
  ...
  at_subtitle_product:
    "Product-wide · shared by every course under this product · hidden from learners · fed to the AI assistant only · PDF / TXT / Markdown / DOCX ≤ 16 MB",
  ...
  sp_p_sec_rto: "Regional Tourism Organisations",
  sp_p_rto_hint: "Select the RTO region(s) your company operates in.",
  ...
  // Quiz panel
  lr_quiz_passed_chip: "✓ You've passed the final exam.",
  lr_exam_title: "Final exam",
  lr_exam_sub: "After all chapters",
  lr_exam_intro:
    "Answer the questions below to complete the course. Pass to earn your badge.",
  lr_quiz_heading: "Exam questions",
  lr_quiz_instructions: "Answer {n} questions — pass {pass} of {n} to earn your badge.",
  ...
  // ===== Explore page =====
  ex_label: "/EXPLORE",
  ex_title: "Explore suppliers",
  ex_subtitle: "The New Zealand tourism companies offering training on Libretour.",
  ex_attribution: "Imagery via Pexels",
  ex_empty: "No suppliers to show yet.",
  ...
  cat_attractions: "Attractions, food and beverage experiences",
  cat_adventure: "Adventure and outdoor",
  cat_culture: "Culture and heritage",
  cat_water: "Water transport and cruise",
  cat_land: "Land transport",
  cat_air: "Air transport",
  cat_accommodation: "Accommodation",
  cat_tour: "Tour services",
  cat_rto: "Regional and District Tourism Organisations",
  cat_other: "More",
...
const zhCN: Dict = {
  ...
  ai_empty_state: "有关本课程的任何问题都可以问我。",
  ...
  admin_sup_disabled: "已停用",
  admin_sup_pending: "待审核",
  admin_sup_enable: "启用",
  admin_sup_disable: "停用",
  delisted_course: "该课程已下架。",
  delisted_product: "该产品已下架。",
  delisted_supplier: "该供应商已下架。",
  delisted_back: "返回我的学习",
  sd_products: "产品（{n}）",
  sd_empty: "暂未发布产品。",
  ...
  ed_regen_heading: "本模块 · 旁白预览",
  ed_regen_sub: "只生成本模块主语言的旁白，供编辑时快速试听。所有语言会在发布时统一生成。",
  ed_regen_module: "🎧 生成旁白（预览）",
  ed_republish: "重新生成并发布",
  pub_title: "发布课程",
  pub_sub: "选择要发布的语言及各自音色。系统会在后台为所选每个语言×模块生成翻译与旁白，完成后课程上线。请先保存修改。",
  pub_no_overwrite: "不覆盖已有旁白（只补缺失的）",
  pub_running: "发布中…正在生成旁白",
  pub_toast_running: "正在生成旁白…",
  pub_toast_done: "旁白生成完毕,课程已发布",
  pub_go: "发布",
  ed_regenerating: "后台生成中…",
  ed_regen_bg: "正在后台运行——可继续其它操作，完成后会提示你。",
  ...
  em_block_video_yt_ph: "粘贴 YouTube 分享链接（youtu.be/… 或 youtube.com/watch?v=…）",
  em_video_upload: "⬆ 上传视频文件",
  em_video_uploaded: "已上传视频文件",
  em_video_remove: "移除文件",
  em_video_hint: "MP4 / WebM / MOV ≤ 2 GB。上传的文件优先于链接。",
  ...
  em_block_narrate: "🔊 纳入旁白",
  em_slide_remove: "移除幻灯片",
  em_slide_hint: "可一次选择多张图片，2 张以上学员端将以轮播展示。",
  em_block_tip:
  ...
  cq_title: "课程统考",
  cq_subtitle: "学完所有章节后统一考一次 · 通过即获得徽章",
  cq_generate_title: "根据整门课程内容生成题目",
  cq_empty: "还没有题目 — 没有统考时,读完所有章节即可获得徽章。",
  em_ai_only: "仅 AI",
  ...
  ui_video_too_large: "该视频 {mb} MB,超过 2 GB 上限。请改用更小的文件或 YouTube 链接。",
  ...
  at_subtitle_product:
    "产品级 · 该产品下所有课程共享 · 对学员隐藏 · 仅供 AI 助手使用 · PDF / TXT / Markdown / DOCX ≤ 16 MB",
  ...
  sp_p_sec_poc: "主联系人",
  sp_p_sec_rto: "地方旅游局（RTO）",
  sp_p_rto_hint: "选择贵公司经营所在的地方旅游局区域（可多选）。",
  ...
  // Quiz panel
  lr_quiz_passed_chip: "✓ 你已通过课程统考。",
  lr_exam_title: "课程统考",
  lr_exam_sub: "学完所有章节后",
  lr_exam_intro: "回答下列题目以完成课程。通过即可获得徽章。",
  lr_quiz_heading: "考题",
  lr_quiz_instructions: "回答 {n} 道题 — {n} 道中答对 {pass} 道即可获得徽章。",
  ...
  ex_label: "/探索",
  ex_title: "探索供应商",
  ex_subtitle: "在 Libretour 提供培训的新西兰旅游企业。",
