...
export default function LearnError({
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 p-8 font-mono text-small leading-relaxed">
      <h1 className="text-title font-semibold mb-3">/learn render error (debug)</h1>
      ...
      <pre className="whitespace-pre-wrap text-caption text-slate-700 bg-slate-50 border border-slate-200 rounded p-3 overflow-x-auto">
