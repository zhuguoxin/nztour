    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans antialiased text-[16px]">
      ...
      <main className="px-5 sm:px-8 py-12 sm:py-16 max-w-3xl mx-auto">
        ...
        <section className="mt-10 space-y-4">
          <h2 className="text-[20px] font-semibold text-slate-900">{zh ? "我们为何存在" : "Why we exist"}</h2>
        ...
        <section className="mt-10 space-y-4">
          <h2 className="text-[20px] font-semibold text-slate-900">{zh ? "我们的理念" : "What we believe"}</h2>
        ...
        <section className="mt-10 space-y-4">
          <h2 className="text-[20px] font-semibold text-slate-900">{zh ? "公司信息" : "The company"}</h2>
          <p className="text-[15px] text-slate-700 leading-relaxed">
            {zh ? (
              <>
