...
export function SortableList<T extends SortableItem>({
  ...
  return (
    <>
      {error ? (
        <div className="mb-2 text-caption text-rose-600 bg-rose-950/40 border border-rose-500/30 rounded-md px-2 py-1">
          {error}
        </div>
      ) : null}
...
export function GrabHandle({ handle }: { handle: DragHandleProps }) {
  ...
  return (
    <button
      ...
      className="cursor-grab active:cursor-grabbing text-slate-500 hover:text-slate-900 px-1.5 py-1 rounded-md hover:bg-slate-100 touch-none"
